...
using Swartz.WebApi.Extensions;

namespace Swartz.WebApi
{
    public class DefaultSwartzWebApiHttpControllerActivator : IHttpControllerActivator
    {
        private readonly HttpConfiguration _configuration;

        public DefaultSwartzWebApiHttpControllerActivator(HttpConfiguration configuration)
        {
            ...
            Type controllerType)
        {
            ...
            {
                controllerContext.ControllerDescriptor = new HttpControllerDescriptor(_configuration,
                    controllerDescriptor.ControllerName, controllerType);
