...
{
    public class DefaultSwartzWebApiHttpControllerSelector : DefaultHttpControllerSelector
    {
        private readonly HttpConfiguration _configuration;

        public DefaultSwartzWebApiHttpControllerSelector(HttpConfiguration configuration) : base(configuration)
        {
