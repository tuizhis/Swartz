...
namespace Swartz.Events
{
    public class EventsRegistrationSource : IRegistrationSource
    {
            ...
            Func<Service, IEnumerable<IComponentRegistration>> registrationAccessor)
        {
            ...
            var interfaceProxyType = _proxyBuilder.CreateInterfaceProxyTypeWithoutTarget(serviceType, new Type[0],
                ProxyGenerationOptions.Default);

            var rb = RegistrationBuilder.ForDelegate((ctx, parameters) =>
            {
