...
namespace Swartz.Events
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, MethodInfo> EnumerableOfTypeTDictionary =
        ...
        public static object Adjust(IEnumerable results, Type returnType)
        {
            ...
            var enumerableOfTypeT = EnumerableOfTypeTDictionary.GetOrAdd(returnType,
                type =>
                    typeof(Enumerable).GetGenericMethod("OfType", type.GetGenericArguments(),
    ...
    {
        public static MethodInfo GetGenericMethod(this Type t, string name, Type[] genericArgTypes, Type[] argTypes,
            Type returnType)
        {
            return (from m in t.GetMethods(BindingFlags.Public | BindingFlags.Static)
                where m.Name == name &&
                      ...
                      (m.ReturnType.IsGenericType && !m.ReturnType.IsGenericTypeDefinition
