...
namespace Swartz.Environment
{
    ...
    internal class WorkValues<T> where T : class
    {
        ...
        public IDictionary<Work<T>, T> Values { get; }
    }
    ...
    internal class WorkRegistrationSource : IRegistrationSource
    {
        ...
        private static IComponentRegistration CreateMetaRegistration<T>(Service providedService,
            IComponentRegistration valueRegistration) where T : class
        {
